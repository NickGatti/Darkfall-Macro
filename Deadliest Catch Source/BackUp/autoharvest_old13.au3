...
Global $x, $y, $z, $xdistance, $xvarcurrent, $xvarstatic, $ydistance, $yvarcurrent, $yvarstatic, $headinghigh, $headinglow, $direction, $xgo, $ygo, $heading
Global $Paused
...
Func DirectionAngle($deltaX, $deltaY)
    ...
    $angle += (($deltaY > 0) And ($deltaX < 0)) * $pi
    Return Round(Mod($angle * 180 / $pi + 360, 360), 12)
