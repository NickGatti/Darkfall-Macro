...
Func drive()
	...
	For $i = 3 To $totalUsed
		Do
			...
			$headingP = $faceDir + 15
			findDistance($i)
			MsgBox(0,"Hi","IM FACING IT")
			ToolTip("(If heading:) " & $headingM & " (is less than:) " & $faceDir & " (and Heading:) " & $headingP & " (greater than:) " & $faceDir, 0, 0)
			If ($headingM <= $faceDir And $headingP >= $faceDir) And $currentDistance > 50000 Then
				Do
					;MsgBox(0,"Hi",$headingM & " is less than " & $faceDir & " and " & $headingP & " greater than " & $faceDir)
					findFacing($i)
					findDistance($i)
					$var = $heading - 180
					MsgBox(0,"I need to face", $faceDir)
					$faceDirAct = $heading
					...
					EndIf
					Sleep(50)
					;ToolTip("Not Facing", 0, 0)
					;ToolTip("FUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCKFUCK",0,0)
