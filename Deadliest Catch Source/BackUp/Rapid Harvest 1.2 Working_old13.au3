...
Global $paused, $arrayLoc, $currentSpot = 2, $totalUsed = 2, $stamx, $stamy, $fullstamcolor
...
While 1
	ToolTip("Setting node number: " & $totalUsed, 0, 0)
WEnd
...
Func init()
	If Not WinExists("Darkfall Tools") Then
		ToolTip("Script is opening DFT.", 0, 0)
		Local $text, $var
		Run("loader.exe")
		Do
			Sleep(100)
	...
	EndIf
	ToolTip("Script is activating Darkfall Online.", 0, 0)
...
Func getCurrentXY()
	...
	MsgBox(0,"",$yCurrentLoc)
	MsgBox(0,"",$directionIamFacing)
