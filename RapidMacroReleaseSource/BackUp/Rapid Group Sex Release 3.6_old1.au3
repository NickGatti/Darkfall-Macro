...
;Rapid Group Sex BY Diminished Hail: Release Version 3.6
MsgBox(0, "Version", "Rapid Group Sex BY Diminished Hail: Release Version 3.6")
...
$Main = GUICreate("Group Sex 3.6", 520, 370, 200, 200)
