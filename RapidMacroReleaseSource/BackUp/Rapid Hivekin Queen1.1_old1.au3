;Rapid Hivekin Queen BY Diminished Hail: Release Version 1.1
MsgBox(0, "Version", "Rapid Hivekin Queen BY Diminished Hail: Release Version 1.1")
...
Func getStatusBar()
	While 1 = 1
		...
		If $go = 4 Then
			...
			$ycen = $size[1] / 2
			If $size[0] <> 1152 Then
				MsgBox(0,"ERROR!","ERROR Must be in windowed mode in 1152 x 864")
				Exit
			EndIf
			$x1 = $xcen + 80
			Do
				...
				Until $pixVar = $fullhealthcolor Or $y1 > ($ycen + 65)
