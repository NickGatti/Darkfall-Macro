...
;### Tidy Error -> "wend" is closing previous "case" on line 319
EndSelect
		WEnd

;### Tidy Error -> select Not closed before "Func" statement.
...
;### Tidy Error -> "func" cannot be inside any IF/Do/While/For/Case/Func statement.
		Func gethotkey()
			...
			Do
				...
				Next
			Until $key
		EndFunc   ;==>gethotkey;### Tidy Error -> select is never closed in your script.
;### Tidy Error -> select is never closed in your script.
