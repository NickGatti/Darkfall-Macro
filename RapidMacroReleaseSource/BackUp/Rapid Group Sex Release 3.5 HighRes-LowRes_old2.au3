...
;Rapid Group Sex BY Diminished Hail: Release Version 3.5
MsgBox(0, "Version", "Rapid Group Sex BY Diminished Hail: Release Version 3.5 High Res/Low Res")
...
$Main = GUICreate("Group Sex 3.5 High Res/Low Res", 520, 370, 200, 200)
