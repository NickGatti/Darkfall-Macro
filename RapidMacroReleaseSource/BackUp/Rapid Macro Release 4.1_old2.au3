...
MsgBox(0, "Version", "Rapid Macro BY Diminished Hail: Release Version 4.1")
...
While 1 = 1
	...
	Call("Dummymode")
;### Tidy Error -> "else" is closing previous "while" on line 602
Else
	Call("Melee")
;### Tidy Error -> "endif" is closing previous "while" on line 602
EndIf
