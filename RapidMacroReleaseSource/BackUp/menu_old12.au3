			...
			For $i = 0 To 21
				Select
					Case GUICtrlRead($combobox) = $comboxarray[$i]
						...
						RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "inputGMResponse", "REG_SZ", $GMResponseREG)
						RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "inputAttackDelay", "REG_SZ", $AttackDelayREG)
						RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "inputVMwareDelay", "REG_SZ", $VMWareREG)
RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "inputIronSkin", "REG_SZ", $VMWareREG)
RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "inputDisease", "REG_SZ", $VMWareREG)
RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "inputHaste", "REG_SZ", $VMWareREG)
		...
		Select
			Case $nMsg = $Button2
				RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", , "REG_SZ", $CastDisease)
WEnd
