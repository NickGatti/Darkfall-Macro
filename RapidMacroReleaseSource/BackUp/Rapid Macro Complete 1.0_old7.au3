...
Global $radioval = -1, $equiparmor = -1, $gmresponse = -1, $menuGO = -1, $guiread, $CastDisease, $CastIron, $CastHaste, $gmx, $gmy, $AttackDelay, $VMWare, $notargetcolor, $notargetx, $notargety, $pixVar2, $stamicon, $stamiconx, $stamicony, $Radio4, $Radio5
...
Global $VMWareREG, $unsheathe, $HTMK, $guimode, $Checkbox4, $Checkbox5, $Checkbox6, $button3, $add1, $add2, $add3, $send, $state, $lbl3, $Label7, $Input7, $SpecialAttackCDREG, $time4, $SpecialAtk, $castingwait, $castingwaitREG, $label8, $Input8, $dummymode, $healcasting, $nohealcasting, $MTSK, $STHK
...
$Spell1 = RegRead("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "Spell1")
$Spell2 = RegRead("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "Spell2")
$Spell3 = RegRead("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "Spell3")
$Spell4 = RegRead("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "Spell4")
$Spell5 = RegRead("HKEY_LOCAL_MACHINE\SOFTWARE\DimsMacro", "Spell5")
...
$Form1_1 = GUICreate("Rapid Macro Complete Version 1.0 By: Diminished Hail", 634, 448, 192, 124)
...
$Radio4 = GUICtrlCreateRadio("No Heal Magic Training", 200, 40, 133, 17)
$Radio5 = GUICtrlCreateRadio("Magic Training With Heal", 340, 40, 143, 17)
