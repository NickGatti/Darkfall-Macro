...
Global $keylist[126]
$keylist[0] = ""
$keylist[1] = MouseClick("left")
$keylist[2] = "MouseClick(" right")"
$keylist[3] = "Windows 2000/XP: X1 mouse button CAN NOT SEND"
$keylist[4] = "MouseClick(" middle")"
$keylist[5] = "Windows 2000/XP: X2 mouse button"
$keylist[6] = ""
$keylist[7] = "Send(" {CTRL}")"
$keylist[8] = "Send(" {BACKSPACE}")"
$keylist[9] = "Send(" {TAB}")"
$keylist[10] = ""
$keylist[11] = ""
$keylist[12] = ""
$keylist[13] = "Send(" {NUMPADENTER}")"
$keylist[14] = ""
$keylist[15] = ""
$keylist[16] = "Send(" {SHIFT}")"
$keylist[17] = "Send(" {CTRL}")"
$keylist[18] = "Send(" {ALT}")"
$keylist[19] = ""
$keylist[20] = "Send(" {CAPSLOCK toggle}")"
$keylist[21] = ""
$keylist[22] = ""
$keylist[23] = "Send(" {PGUP}")"
$keylist[24] = "Send(" {PGDN}")"
$keylist[25] = "Send(" {END}")"
$keylist[26] = "Send(" {HOME}")"
$keylist[27] = ""
$keylist[28] = "Send(" {ESC}")"
$keylist[29] = ""
$keylist[30] = ""
$keylist[31] = ""
$keylist[32] = "Send(" {SPACE}")"
$keylist[33] = ""
$keylist[34] = ""
$keylist[35] = ""
$keylist[36] = ""
$keylist[37] = "Send(" {LEFT}")"
$keylist[38] = "Send(" {UP}")"
$keylist[39] = "Send(" {RIGHT}")"
$keylist[40] = "Send(" {DOWN}")"
$keylist[41] = ""
$keylist[42] = ""
$keylist[43] = ""
$keylist[44] = ""
$keylist[45] = "Send(" {INSERT}")"
$keylist[46] = "Send(" {DEL}")"
$keylist[47] = ""
$keylist[48] = "Send(" 0")"
$keylist[49] = "Send(" 1")"
...
$keylist[104] = ""
$keylist[105] = ""
$keylist[106] = "Send(" {NUMPADMULT}")"
$keylist[107] = "Send(" {NUMPADADD}")"
$keylist[108] = ""
$keylist[109] = "Send(" {NUMPADSUB}")"
$keylist[110] = ""
$keylist[111] = "Send(" {NUMPADDIV}")"
$keylist[112] = "Send(" {F1}")"
$keylist[113] = "Send(" {F2}")"
$keylist[114] = "Send(" {F3}")"
$keylist[115] = "Send(" {F4}")"
...
$keylist[119] = "Send(" {F8}")"
$keylist[120] = "Send(" {F9}")"
$keylist[121] = "Send(" {F10}")"
$keylist[122] = "Send(" {F11}")"
$keylist[123] = "Send(" {F12}")"
$keylist[123] = ""
$keylist[124] = ""
$keylist[125] = ""
...
While 1
	...
	Select
		Case $nMsg = $Button2
			Select
				Case GUICtrlRead($combobox) = "Unsheathe Key"
					Call("gethotkey")
					$unsheathekey = $hotkey
					$Label3 = GUICtrlCreateLabel($unsheathekey & "...Saved!", 390, 140, 140, 97)
			EndSelect
	EndSelect
