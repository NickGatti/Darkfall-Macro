...
MsgBox(0, "Version", "Rapid Macro BY Diminished Hail: Release Version 4.3")
...
Global $VMWareREG, $unsheathe, $HTMK, $guimode, $Checkbox4, $Checkbox5, $Checkbox6, $button3, $add1, $add2, $add3, $send, $state, $lbl3, $Label7, $Input7, $SpecialAttackCDREG, $time4, $SpecialAtk, $castingwait, $castingwaitREG, $label8, $Input8
...
$Form1_1 = GUICreate("Rapid Macro 4.1 By: Diminished Hail", 634, 448, 192, 124)
...
$Label8 = GUICtrlCreateLabel("Casting Cooldown (Default 0)", 340, 360, 66, 17)
$Input8 = GUICtrlCreateInput($castingwaitREG, 410, 360, 121, 21)
GUISetState(@SW_SHOW)
