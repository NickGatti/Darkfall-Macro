...
;Rapid Hivekin Queen BY Diminished Hail: Release Version 1.3
MsgBox(0, "Version", "Rapid Hivekin Queen BY Diminished Hail: Release Version 1.3")
	...
	While 1 = 1
		...
		If $result And $go = 4 Then
			...
			If $go = 5 Then
				Return
			EndIf
;### Tidy Error -> "wend" is closing previous "if" on line 141
		WEnd
;### Tidy Error -> "endfunc" is closing previous "while" on line 58
...
;### Tidy Error -> "func" cannot be inside any IF/Do/While/For/Case/Func statement.
	Func checkstaff()
		...
		If $pixVar <> $stamicon Then
			...
			Until $result Or $result2
		EndIf
	EndFunc   ;==>checkstaff;### Tidy Error -> func is never closed in your script.
