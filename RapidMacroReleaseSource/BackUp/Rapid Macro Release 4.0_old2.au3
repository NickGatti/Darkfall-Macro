...
MsgBox(0, "Version", "Rapid Macro BY Diminished Hail: Release Version 4.0")
...
$Form1_1 = GUICreate("Rapid Macro 4.0 By: Diminished Hail", 634, 448, 192, 124)
...
While 1 = 1
	If $go = 0 Then
		Call("getstatusbar")
	EndIf
	If $equiparmor <> 3 Then Call("Melee")
	If $equiparmor = 3 Then Call("Dummymode")
WEnd
