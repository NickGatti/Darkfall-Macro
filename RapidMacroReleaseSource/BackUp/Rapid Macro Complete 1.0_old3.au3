...
Global $VMWareREG, $unsheathe, $HTMK, $guimode, $Checkbox4, $Checkbox5, $Checkbox6, $button3, $add1, $add2, $add3, $send, $state, $lbl3, $Label7, $Input7, $SpecialAttackCDREG, $time4, $SpecialAtk, $castingwait, $castingwaitREG, $label8, $Input8, $dummymode, $healcasting, $nohealcasting
	...
	While 1 = 1
		...
		If $go = 4 Then
			...
			If $go = -1 Then
				Return
			EndIf
;### Tidy Error -> "wend" is closing previous "if" on line 635
		WEnd
;### Tidy Error -> "endfunc" is closing previous "while" on line 561
	...
	While 1 = 1
		...
		If $nohealcasting = True Then Call("nohealcast")
		If $healcasting = True Then Call("healcast")
	WEnd
...
;### Tidy Error -> "func" cannot be inside any IF/Do/While/For/Case/Func statement.
	Func healcast()
	EndFunc   ;==>healcast;### Tidy Error -> func is never closed in your script.
