...
Global $x1 = 0, $y1 = 0, $go = 0, $manax = 0, $manay = 0, $fullmanacolor = 0, $stamx = 0, $stamy = 0, $fullstamcolor = 0, $healthx = 0, $healthy = 0, $fullhealthcolor = 0, $HOK = $SLT[0], $stamicon, $stamiconx, $stamicony, $stamicon2
