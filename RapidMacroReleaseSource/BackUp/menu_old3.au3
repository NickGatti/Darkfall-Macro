		...
		Do
			...
			If $nMsg = $Button2 Then
				...
				Do
					...
					Next
				Until $key
;### Tidy Error -> "until" is closing previous "if" on line 190
			Until Not $nMsg
;### Tidy Error -> "endif" is closing previous "do" on line 188
		EndIf
		EndIf
;### Tidy Error -> "wend" is closing previous "if" on line 186
	WEnd
...
;### Tidy Error -> "func" cannot be inside any IF/Do/While/For/Case/Func statement.
	...
	EndFunc   ;==>_IsPressed;### Tidy Error -> while is never closed in your script.
