...
MsgBox(0, "Version", "Rapid Magic BY Diminished Hail: Release Version 1.3")
...
Global $findImage, $resultPosition, $x, $y, $tolerance, $findImage, $result, $x1, $y1, $right, $bottom
Global $result[2]
$result[0] = 0
Global $array[6]
$array[0] = 0
...
Global $x1 = 0, $y1 = 0, $go = 0, $mana = 0, $stam = 0, $health = 0, $manax = 0, $manay = 0, $fullmanacolor = 0, $stamx = 0, $stamy = 0, $fullstamcolor = 0, $healthx = 0, $healthy = 0, $fullhealthcolor = 0, $HOK = $SLT[0], $stamicon, $stamiconx, $stamicony, $stamicon2
